<template>
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
		...
		<view class="list" :style='{"width":"100%","padding":"0","margin":"40rpx 0"}'>
			<view v-for="(item,index) in list " v-bind:key="index" :style='{"border":"2rpx solid #b0cb5e","padding":"24rpx 30rpx 48rpx","margin":"0 0 40rpx","borderRadius":"8rpx","background":"#f8fff7","display":"flex","width":"100%","justifyContent":"space-between"}'>
		...
		<!--list end-->
		<button :style='{"padding":"0 40rpx","margin":"40rpx 20rpx 40rpx 0","color":"#333","borderRadius":"60rpx","textAlign":"center","background":"linear-gradient(30deg, rgba(242,239,219,1) 0%, rgba(170,210,255,1) 100%)","width":"auto","lineHeight":"80rpx","float":"right","height":"80rpx"}' @click="onUpdateTap()">新增</button>
	</mescroll-uni>
</template>
