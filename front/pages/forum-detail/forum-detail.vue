<template>
	<view :style='{"alignContent":"flex-start","width":"100%","padding":"0","flexWrap":"wrap","background":"#fff","display":"flex"}'>
		...
		<view :style='{"margin":"20rpx auto 0","borderRadius":"0px 0px 0 0","color":"#333","textAlign":"center","background":"#fff","width":"calc(100% - 0px)","fontSize":"32rpx","lineHeight":"68rpx"}'>
			{{forum.title}}
		</view>
		<view :style='{"padding":"0 24rpx","margin":"0 auto","color":"#888","textAlign":"center","background":"#fff","width":"calc(100% - 0px)","fontSize":"28rpx"}'>
		...
		<view class="operateView" :style='{"padding":"24rpx 24rpx 0","margin":"0 auto 0","alignItems":"center","background":"#fff","display":"flex","width":"calc(100% - 0px)","fontSize":"30rpx","justifyContent":"space-between","order":"2"}'>
			<view v-if="!likeType" :style='{"width":"50%","padding":"16rpx 50rpx","borderRadius":"0","background":"#b0cb5e","justifyContent":"center","display":"flex"}' @click="likeClick">
				<span class="icon iconfont icon-zan10" :style='{"color":"#fff","order":"3"}'></span>
				<span :style='{"color":"#fff","margin":"0 10rpx 0 0"}'>赞({{allZan}})</span>
			</view>
			<view v-if="likeType" :style='{"width":"50%","padding":"16rpx 50rpx","color":"#fff","textAlign":"center","background":"#b0cb5e"}' @click="likeClick">
				<span class="icon iconfont icon-zan10" :style='{"color":"#fdce9c","order":"3"}'></span>
				<span :style='{"color":"#fdce9c"}'>取消赞({{allZan}})</span>
			</view>
			<view v-if="!collectType" :style='{"width":"50%","padding":"16rpx 50rpx","borderRadius":"0","background":"#8fb9e9","justifyContent":"center","display":"flex"}' @click="collectClick">
				<span class="icon iconfont icon-shoucang10" :style='{"color":"#fff","order":"2"}'></span>
				<span :style='{"color":"#fff","margin":"0 10rpx 0 0"}'>收藏({{allCollect}})</span>
			</view>
			<view v-if="collectType" :style='{"width":"50%","padding":"16rpx 50rpx","color":"#666","textAlign":"center","background":"#8fb9e9"}' @click="collectClick">
				<span class="icon iconfont icon-shoucang10" :style='{"color":"#fdce9c","order":"2"}'></span>
				<span :style='{"color":"#fdce9c"}'>取消收藏({{allCollect}})</span>
			</view>
		</view>
		...
		<view :style='{"width":"calc(100% - 48rpx)","margin":"40rpx auto 168rpx","background":"none","order":"11"}'>
			<view :style='{"border":"2rpx solid #b0cb5e","width":"100%","padding":"48rpx 0px 48rpx","margin":"0 0 40rpx","borderRadius":"40rpx","background":"#f8fff7"}' v-for="comment in commentData" :key="comment.id">
				...
				<view :style='{"padding":"0 20rpx 20rpx 100rpx","borderColor":"#b0cb5e","fontSize":"28rpx","color":"#333","borderStyle":"solid","borderWidth":"0 0 2rpx"}'>
					<rich-text :style='{"color":"#000"}' :nodes="comment.content"></rich-text>
					<view :style='{"width":"100%","margin":"20rpx 0","alignItems":"center","justifyContent":"flex-end","display":"flex"}'>
						<text @tap="onReplyTap(comment.id)" :style='{"padding":"6rpx 20rpx","margin":"0 0px 0 0","color":"#fff","borderRadius":"0px","textAlign":"center","background":"#b0cb5e","width":"50%"}'>回复</text>
						<text @tap="delClick(comment.id)" v-if="userid==comment.userid" :style='{"border":"0px solid #ccc","padding":"6rpx 20rpx","margin":"0 20rpx 0 0","color":"#666","borderRadius":"0px","textAlign":"center","background":"#ededed","width":"50%"}'>删除</text>
					</view>
				</view>
				<view :style='{"width":"100%","padding":"0 40rpx"}' v-if="comment.childs">
					<view :style='{"width":"100%"}' v-for="item in comment.childs" :key="item.id">
						...
						<view :style='{"padding":"0 20rpx 20rpx 100rpx","borderColor":"#b0cb5e","fontSize":"28rpx","color":"#333","borderStyle":"solid","borderWidth":"0 0 2rpx"}'>
							...
							<view :style='{"width":"100%","alignItems":"center","justifyContent":"flex-end","display":"flex"}'>
								<text :style='{"border":"0px solid #ccc","padding":"6rpx 20rpx","color":"#666","borderRadius":"0px","textAlign":"center","background":"#ededed","width":"50%"}' @tap="delClick(item.id)" v-if="userid==item.userid">删除</text>
							</view>
						</view>
					</view>
				</view>
